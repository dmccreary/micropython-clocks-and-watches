...
def main():
    ...
    Button(pin=Pin(6, mode=Pin.IN, pull=Pin.PULL_UP), callback=hour_pressed)
    Button(pin=Pin(7, mode=Pin.IN, pull=Pin.PULL_UP), callback=minute_pressed)
