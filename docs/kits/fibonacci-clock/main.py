# Example code: https://github.com/Guitarman9119/Raspberry-Pi-Pico-/blob/main/Fibonacci%20clock/code/main.py
# Example Instructable: Raspberry Pi Pico W - Fibonacci Clock: https://www.instructables.com/Raspberry-Pi-Pico-W-Fibonacci-Clock/
from machine import Pin, RTC  # Import necessary classes
import utime
import json
import network
import urequests
# Node, this code uses a very old Neopixel library - not the current built-in library
