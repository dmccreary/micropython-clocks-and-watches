...
We can create custom functions for drawing larger fonts.  Here we have a byte array
of 5X8 fonts.  The function ```character()``` draws individual characters one at a time.
