# Drawing a Scalable Alarm Bell Icon

![](../../img/alarm-bell-icons.jpg)

## Sample Prompt

!!! prompt
    Using the MicroPython poly function, please create a Python function that draws an alarm icon on a 22x24 grid.  The function should have three parameters: x, y and scale where x and y are
    the upper left corner coordinates.  Just draw the bell body and the clapper.

    Test the icon at scales from 12 to 36.
